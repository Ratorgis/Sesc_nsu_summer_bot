...
kult_kb = ReplyKeyboardMarkup(
    keyboard = [ 
        ...
        [
            KeyboardButton(text='Алина Беляева')
        ],
        [
...
cooker_kb = ReplyKeyboardMarkup(
    keyboard = [ 
        [
            KeyboardButton(text='Александр Куулар'),
        ],
        [
            KeyboardButton(text='Станислав Конорев'),
        ],
        [
        ...
        [
            KeyboardButton(text='Алексей Деревцов')
        ],
        [
